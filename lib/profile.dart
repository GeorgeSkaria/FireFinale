...
class ProfilePage extends StatelessWidget {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    Expanded(
                      ...
                      child: Container(
                        ...
                        child: Text(
                          '1234 Street Name,\nCity, Country',
                          style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.black, fontFamily: 'SpecialFont'),
                        ),
                      ),
                    ),
                ...
                Text(
                  'User Details',
                  style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.black, fontFamily: 'SpecialFont'),
                ),
                const SizedBox(height: 10),
                Text(
                  'Name: John Doe\nEmail: john.doe@example.com\nPhone: +1234567890',
                  style: TextStyle(fontSize: 16, color: Colors.black, fontFamily: 'SpecialFont'),
                ),
                const SizedBox(height: 20),
                Text(
                  'Options',
  ...
  Widget buildOptionItem({required IconData icon, required String title}) {
    return ListTile(
      ...
      title: Text(title, style: TextStyle(color: Colors.black, fontFamily: 'SpecialFont')),
      onTap: () {
        // Handle onTap event
      },
    );
